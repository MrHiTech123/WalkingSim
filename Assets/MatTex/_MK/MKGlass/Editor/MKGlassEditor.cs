...
namespace MK.Glass
{
    ...
    public class MKGlassEditor : ShaderGUI
    {
        ...
        private void SetGIFlags()
        {
            ...
            {
                bool emissive = true;
                if (MKGlassMaterialHelper.GetEmissionColor(obj) == Color.black)
                {
                    emissive = false;
                }
        ...
        private void LightModelPopup(MaterialEditor materialEditor)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    mat.SetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL, lightModel.floatValue);
                }
        ...
        //Rendermode
        private void RenderModePopup(MaterialEditor materialEditor)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                {
                    mat.SetFloat(MKGlassMaterialHelper.PropertyNames.RENDER_MODE, renderMode.floatValue);
                }
        ...
        override public void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            if (HandleBehavior("Render", ref showRenderBehavior, materialEditor))
            {
                ...
                RenderModePopup(materialEditor);
                if (lightModel.floatValue != (int)(LightModel.Unlit))
                {
        ...
        private void ManageVariantsInternal()
        {
            ...
            foreach (Material mat in useFastMode.targets)
            {
                if(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_FAST_MODE) == 1.0f)
                {
                    if (mat.shader == defaultDoubleSidedGlass)
        ...
        private void ManageKeywordsColorSource()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetMainTexture(mat), ALBEDO_MAP, mat);
            }
        }
        ...
        private void ManageKeywordsLightModel()
        {
            ...
            foreach (Material mat in lightModel.targets)
            {
                SetKeyword(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL) == 1.0f, LIGHT_MODEL[1], mat);
                SetKeyword(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL) == 2.0f, LIGHT_MODEL[2], mat);
                SetKeyword(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL) == 3.0f, LIGHT_MODEL[3], mat);
            }
        }
        ...
        private void ManageKeywordsOcclusion()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetOcclusionMap(mat), OCCLUSION, mat);
            }
        }
        ...
        private void ManageKeywordsRim()
        {
            ...
            {
                SetKeyword(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_RIM) == 1.0f, RIM, mat);
            }
        }
        ...
        private void ManageKeywordsDetailAlbedo()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetDetailTexture(mat), DETAIL_MAP, mat);
            }
        }
        ...
        private void ManageKeywordsDetailBump()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetDetailNormalMap(mat), DETAIL_BUMP_MAP, mat);
            }
        }
        ...
        private void ManageKeywordsBump()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetBumpMap(mat), BUMP_MAP, mat);
            }
        }
        ...
        private void ManageKeywordsSpecular()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetSpecularMap(mat) != null && mat.GetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL) == 2.0f || mat.GetFloat(MKGlassMaterialHelper.PropertyNames.LIGHT_MODEL) == 3.0f, SPECULAR_MAP, mat);
            }
        }
        ...
        private void ManageKeywordsEmission()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetEmissionMap(mat) != null && MKGlassMaterialHelper.GetEmissionColor(mat) != Color.black, EMISSION_MAP, mat);
            }
            foreach (Material mat in emissionColor.targets)
            {
                SetKeyword(MKGlassMaterialHelper.GetEmissionMap(mat) == null && MKGlassMaterialHelper.GetEmissionColor(mat) != Color.black, EMISSION_DEFAULT, mat);
            }
        }
        ...
        private void ManageKeywordsReflective()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetReflectMap(mat) != null && mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_REFLECTION) == 1.0f, REFLECTIVE_MAP, mat);
            }
            foreach (Material mat in useReflection.targets)
            {
                SetKeyword(MKGlassMaterialHelper.GetReflectMap(mat) == null && mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_REFLECTION) == 1.0f, REFLECTIVE_DEFAULT, mat);
            }
            foreach (Material mat in useFresnel.targets)
            {
                SetKeyword(mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_FRESNEL) == 1.0, REFLECTIVE_FRESNEL, mat);
            }
        }
        ...
        private void ManageKeywordsTranslucent()
        {
            ...
            {
                SetKeyword(MKGlassMaterialHelper.GetTranslucentMap(mat) == null && mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_TRANSLUCENT) == 1.0f, TRANSLUCENT_DEFAULT, mat);
            }
            foreach (Material mat in useTranslucent.targets)
            {
                SetKeyword(MKGlassMaterialHelper.GetTranslucentMap(mat) != null && mat.GetFloat(MKGlassMaterialHelper.PropertyNames.USE_TRANSLUCENT) == 1.0f, TRANSLUCENT_MAP, mat);
            }
        }
