//Basic definitions for the rendering
	...
	//Rim
	#if MKGLASS_LIT && MK_GLASS_FWD_BASE_PASS
		#if _MK_RIM
			#ifndef _MKGLASS_RIM
	...
	//VD
	#if DIRLIGHTMAP_COMBINED || _MK_LIGHTMODEL_PHONG || _MK_LIGHTMODEL_BLINN_PHONG || _MKGLASS_RIM || _MKGLASS_REFLECTIVE || MKGLASS_TLM
		#ifndef MKGLASS_VD
			#define MKGLASS_VD 1
		#endif
	#endif
	...
	#if MKGLASS_UNLIT || (MKGLASS_ML_REF_N_DOT_V || MKGLASS_ML_DOT_V || MKGLASS_MV_REF_N || MKGLASS_ML_REF_N || MKGLASS_N_DOT_HV || MKGLASS_HV || MKGLASS_N_DOT_L || MKGLASS_V_DOT_L || MKGLASS_V_DOT_N) || MKGLASS_LIT || MKGLASS_TC_D
